...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">好站連結管理</h3>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="linkAdd.php" class="btn btn-success">新增</a>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables"
                                    ...
                                    foreach ($recordset as $record) {
                                        ...
                                        <tr>
                                            ...
                                            <td width="60%"><?php echo $record['name']; ?></td>

                                            <td width="15%" align="center"><a href="linkEdit.php?id=<?php echo $record['id']; ?>"
                                                                              class="btn btn-info btn-circle"><i
                                                        class="glyphicon glyphicon-edit"></i></a></td>
                                            <td width="15%" align="center"><a
                                                    href="linkDel.php?id=<?php echo $record['id']; ?>&pic=<?php echo $record['pic'] ?>"
