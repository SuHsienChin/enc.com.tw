...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">最新消息管理</h3>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="newsAdd.php" class="btn btn-success">新增</a>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables"
                                    ...
                                    foreach ($recordset as $record) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="newsEdit.php?id=<?php echo $record['id']; ?>"
                                                   class="btn btn-info btn-circle"><i class="glyphicon glyphicon-edit"></i></a></td>
                                            <td><a href="newsDel.php?id=<?php echo $record['id']; ?>"
