...
(function () {
    ...
    var d = function () {
        ...
        return {
            textNode: i.textNode,
            offset: i.offset,
            character: i.textNode ? i.textNode.getText().charAt(i.offset) : null,
            hitMatchBoundary: i._.matchBoundary
        };
    ...
    var h = function (i, j) {
        ...
        }, i.config.find_highlight)), l = function (y, z) {
            ...
            next: function () {
                ...
                if (z && y && A.offset > 0) {
                    ...
                    while (!z) {
                        ...
                        if (A._.matchWord && !z || A._.walker._.end)break;
                    }
                    A.textNode = z;
                    if (z)A.offset = y ? z.getLength() - 1 : 0; else A.offset = 0;
                }
                return d.call(A);
            }
        };
        ...
        m.prototype = {
            toDomRange: function () {
                ...
                if (z.length < 1) {
                    ...
                    if (A)y.setStartAfter(A); else return null;
                } else {
                ...
                do {
                    z = A.next();
                    if (z.character)B._.cursors.push(z);
                } while (z.character)
                ...
                if (A.type != CKEDITOR.NODE_ELEMENT)A = A.getParent();
                A.scrollIntoView();
                B.updateFromDomRange(y);
            }, removeHighlight: function () {
                var z = this;
                if (!z._.highlightRange)return;
                ...
                if (y.hitMatchBoundary)A._.cursors = z = [];
                z.unshift(y);
                if (z.length > A._.rangeLength)z.pop();
                return y;
            }, moveNext: function () {
                var A = this;
                ...
                if (y.hitMatchBoundary)A._.cursors = z = [];
                z.push(y);
                if (z.length > A._.rangeLength)z.shift();
                return y;
                ...
                if ((z = B[B.length - 1]) && z.textNode)A = new l(n(z)); else A = this._.walker;
                return new m(A, y);
            }, getCursors: function () {
        ...
        var p = 0, q = 1, r = 2, s = function (y, z) {
            ...
            for (var B = 0; B < y.length; B++) {
                A.push(A[B] + 1);
                while (A[B + 1] > 0 && y.charAt(B) != y.charAt(A[B + 1] - 1))A[B + 1] = A[A[B + 1] - 1] + 1;
            }
            this._ = {overlap: A, state: 0, ignoreCase: !!z, pattern: y};
        };
        s.prototype = {
            feedCharacter: function (y) {
                var z = this;
                if (z._.ignoreCase)y = y.toLowerCase();
                for (; ;) {
                    if (y == z._.pattern.charAt(z._.state)) {
                        ...
                        return q;
                    } else if (!z._.state)return p; else z._.state = z._.overlap[z._.state];
                }
                return null;
            }, reset: function () {
                this._.state = 0;
        ...
        var t = /[.,"'?!;: \u0085\u00a0\u1680\u280e\u2028\u2029\u202f\u205f\u3000]/, u = function (y) {
            ...
            searchRange: null, matchRange: null, find: function (y, z, A, B, C, D) {
                var M = this;
                if (!M.matchRange)M.matchRange = new m(new l(M.searchRange), y.length); else {
                ...
                while (G !== null) {
                    ...
                    while (G = M.matchRange.getEndCharacter()) {
                        F = E.feedCharacter(G);
                        if (F == r)break;
                        if (M.matchRange.moveNext().hitMatchBoundary)E.reset();
                    }
                    if (F == r) {
                        if (A) {
                            var H = M.matchRange.getCursors(), I = H[H.length - 1], J = H[0], K = new l(o(J), true), L = new l(n(I), true);
                            if (!(u(K.back().character) && u(L.next().character)))continue;
                        }
                        M.matchRange.setMatched();
                        if (C !== false)M.matchRange.highlight();
                        return true;
                    }
                }
                ...
                if (J.matchRange && J.matchRange.isMatched() && !J.matchRange._.isReplaced && !J.matchRange.isReadOnly()) {
                    ...
                    if (!E)J.matchRange.highlight();
                    J.matchRange._.isReplaced = true;
                    J.replaceCounter++;
                    F = 1;
                } else F = J.find(z, B, C, D, !E);
                a = 0;
                return F;
            }
        };
        ...
        return {
            ...
            contents: [{
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        type: 'button', align: 'left', style: 'width:100%', label: x.find, onClick: function () {
                            var y = this.getDialog();
                            if (!v.find(y.getValueOf('find', 'txtFindFind'), y.getValueOf('find', 'txtFindCaseChk'), y.getValueOf('find', 'txtFindWordChk'), y.getValueOf('find', 'txtFindCyclic')))alert(x.notFoundMsg);
                        }
                    }]
                }, {
                    type: 'vbox',
                    ...
                    children: [{
                        ...
                        isChanged: false,
                        label: x.matchWord
                    }, {type: 'checkbox', id: 'txtFindCyclic', isChanged: false, 'default': true, label: x.matchCyclic}]
                }]
            }, {
                id: 'replace', label: x.replace, accessKey: 'M', elements: [{
                    type: 'hbox',
                    widths: ['230px', '90px'],
                    children: [{
                        type: 'text',
                        ...
                        type: 'button', align: 'left', style: 'width:100%', label: x.replace, onClick: function () {
                            var y = this.getDialog();
                            if (!v.replace(y, y.getValueOf('replace', 'txtFindReplace'), y.getValueOf('replace', 'txtReplace'), y.getValueOf('replace', 'txtReplaceCaseChk'), y.getValueOf('replace', 'txtReplaceWordChk'), y.getValueOf('replace', 'txtReplaceCyclic')))alert(x.notFoundMsg);
                        }
                    }]
                }, {
                    type: 'hbox',
            ...
            onHide: function () {
                ...
                if (v.matchRange && v.matchRange.isMatched()) {
                    ...
                    if (y)i.getSelection().selectRanges([y]);
                }
                delete v.matchRange;
            },
            onFocus: function () {
