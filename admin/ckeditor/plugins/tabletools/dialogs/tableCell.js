...
CKEDITOR.dialog.add('cellProperties', function (a) {
    var b = a.lang.table, c = b.cell, d = a.lang.common, e = CKEDITOR.dialog.validate, f = /^(\d+(?:\.\d+)?)(px|%)$/, g = /^(\d+(?:\.\d+)?)px$/, h = CKEDITOR.tools.bind, i = {
        type: 'html',
        html: '&nbsp;'
    }, j = a.lang.dir == 'rtl';
    ...
    function k(l, m) {
        ...
        a.execCommand(l);
        if (a._.storedDialogs.colordialog)q(a._.storedDialogs.colordialog); else CKEDITOR.on('dialogDefinition', function (r) {
            if (r.data.name != l)return;
    ...
    return {
                ...
                type: 'hbox', widths: ['40%', '5%', '40%'], children: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            width: '100px',
                            label: d.width,
                            validate: e.number(c.invalidWidth),
                            onLoad: function () {
                            ...
                            commit: function (l) {
                                ...
                                if (!isNaN(m))l.setStyle('width', m + n); else l.removeStyle('width');
                            ...
                            type: 'select',
                            id: 'widthType',
                            label: a.lang.table.widthUnit,
                            labelStyle: 'visibility:hidden',
                            'default': 'px',
                            items: [[b.widthPx, 'px'], [b.widthPc, '%']],
                            setup: function (l) {
                        ...
                        type: 'hbox', widths: ['70%', '30%'], children: [{
                            ...
                            commit: function (l) {
                                ...
                                if (!isNaN(m))l.setStyle('height', CKEDITOR.tools.cssLength(m)); else l.removeStyle('height');
                        ...
                        setup: function (l) {
                            ...
                            if (n == 'nowrap' || m)this.setValue('no');
                        },
                        commit: function (l) {
                            if (this.getValue() == 'no')l.setStyle('white-space', 'nowrap'); else l.removeStyle('white-space');
                        ...
                        commit: function (l) {
                            var m = this.getValue();
                            if (m)l.setStyle('text-align', m); else l.removeStyle('text-align');
                        ...
                        commit: function (l) {
                            var m = this.getValue();
                            if (m)l.setStyle('vertical-align', m); else l.removeStyle('vertical-align');
                    ...
                    children: [{
                        ...
                        label: c.rowSpan,
                        'default': '',
                        validate: e.integer(c.invalidRowSpan),
                        setup: function (l) {
                        ...
                        commit: function (l) {
                            var m = parseInt(this.getValue(), 10);
                            if (m && m != 1)l.setAttribute('rowSpan', this.getValue()); else l.removeAttribute('rowSpan');
                        }
                    }, {
                        type: 'text',
                        id: 'colSpan',
                        label: c.colSpan,
                        'default': '',
                        validate: e.integer(c.invalidColSpan),
                        setup: function (l) {
                        ...
                        commit: function (l) {
                            var m = parseInt(this.getValue(), 10);
                            if (m && m != 1)l.setAttribute('colSpan', this.getValue()); else l.removeAttribute('colSpan');
                        }
                    }, i, {
                        type: 'hbox', padding: 0, widths: ['60%', '40%'], children: [{
                            type: 'text', id: 'bgColor', label: c.bgColor, 'default': '', setup: function (l) {
                                var m = l.getAttribute('bgColor'), n = l.getStyle('background-color');
                                this.setValue(n || m);
                            }, commit: function (l) {
                                var m = this.getValue();
                                if (m)l.setStyle('background-color', this.getValue()); else l.removeStyle('background-color');
                        ...
                        children: [{
                            ...
                            commit: function (l) {
                                var m = this.getValue();
                                if (m)l.setStyle('border-color', this.getValue()); else l.removeStyle('border-color');
        ...
        onOk: function () {
            ...
            for (var o = 0; o < n.length; o++)r.commitContent(n[o]);
            l.selectBookmarks(m);
            var p = l.getStartElement(), q = new CKEDITOR.dom.elementPath(p);
            r._.editor._.selectionPreviousPath = q;
            r._.editor.fire('selectionChange', {selection: l, path: q, element: p});
        }
    };
});
