...
(function () {
    var a = 1, b = 2, c = 4, d = {
        ...
        codebase: [{type: a, name: 'codebase'}],
        pluginspage: [{type: c, name: 'pluginspage'}],
        src: [{type: b, name: 'movie'}, {type: c, name: 'src'}],
        name: [{type: c, name: 'name'}],
        align: [{type: a, name: 'align'}],
        title: [{type: a, name: 'title'}, {type: c, name: 'title'}],
        'class': [{type: a, name: 'class'}, {type: c, name: 'class'}],
        width: [{type: a, name: 'width'}, {type: c, name: 'width'}],
        height: [{type: a, name: 'height'}, {type: c, name: 'height'}],
        hSpace: [{type: a, name: 'hSpace'}, {type: c, name: 'hSpace'}],
        vSpace: [{type: a, name: 'vSpace'}, {type: c, name: 'vSpace'}],
        style: [{type: a, name: 'style'}, {type: c, name: 'style'}],
    ...
    for (var f = 0; f < e.length; f++)d[e[f]] = [{type: c, name: e[f]}, {type: b, name: e[f]}];
    ...
    CKEDITOR.dialog.add('flash', function (i) {
        ...
        return {
            title: i.lang.flash.title, minWidth: 420, minHeight: 310, onShow: function () {
                var z = this;
                ...
                }, {type: 'vbox', children: [{type: 'html', id: 'preview', style: 'width:95%;', html: m}]}]
            }, {
                id: 'Upload',
                hidden: true,
                filebrowser: 'uploadButton',
                label: i.lang.common.upload,
                elements: [{type: 'file', id: 'upload', label: i.lang.common.upload, size: 38}, {
                    type: 'fileButton',
                    id: 'uploadButton',
                ...
                elements: [{
                    type: 'hbox',
                    widths: ['45%', '55%'],
                    children: [{type: 'text', id: 'id', label: i.lang.common.id, setup: g, commit: h}, {
                        type: 'text',
                        id: 'title',
