    ...
    var a = function (b, c) {
        ...
        var p = function (C, D) {
            ...
            if (E.getCustomData('isReady') == 'true') {
                if (D == 'check') {
                    var G = C.getValueOf('info', 'txtWidth'), H = C.getValueOf('info', 'txtHeight'), I = E.$.width * 1000 / E.$.height, J = G * 1000 / H;
                    C.lockRatio = false;
                    if (!G && !H)C.lockRatio = true; else if (!isNaN(I) && !isNaN(J))if (Math.round(I) == Math.round(J))C.lockRatio = true;
                } else if (D != undefined)C.lockRatio = D; else C.lockRatio = !C.lockRatio;
            } else if (D != 'check')C.lockRatio = false;
            if (C.lockRatio)F.removeClass('cke_btn_unlocked'); else F.addClass('cke_btn_unlocked');
                ...
                if (F) {
                    ...
                    if (G.count() == 1) {
                        ...
                        if (H == 'img' || H == 'input') {
                            ...
                            if (I.imageElement.getName() == 'img')I.imageEditMode = 'img'; else if (I.imageElement.getName() == 'input')I.imageEditMode = 'input';
                        }
                    }
            ...
            onOk: function () {
                ...
                if (D.imageEditMode) {
                    ...
                    if (c == 'image' && C == 'input' && confirm(b.lang.image.button2Img)) {
                        ...
                        D.imageElement.setAttributes({type: 'image', alt: ''});
                        b.insertElement(D.imageElement);
                    } else {
                    ...
                    if (c == 'image')D.imageElement = b.document.createElement('img'); else {
                        D.imageElement = b.document.createElement('input');
            ...
            contents: [{
                ...
                elements: [{
                    ...
                    commit: function (C, D) {
                        ...
                        } else if (C == f)D.setAttribute('alt', E.getValue()); else if (C == g)D.removeAttribute('alt');
                    }
                }, {
                    type: 'hbox', children: [{
                        type: 'vbox', children: [{
                            ...
                            children: [{
                                ...
                                children: [{
                                    ...
                                    validate: function () {
                                        ...
                                        if (!C)alert(b.lang.common.invalidWidth);
                                        return !!C;
                                    },
                                    setup: r,
                                    commit: function (C, D, E) {
                                        var F = this.getValue();
                                        if (C == d) {
                                            if (F)D.setStyle('width', CKEDITOR.tools.cssLength(F)); else if (!F && this.isChanged())D.removeStyle('width');
                                    ...
                                    validate: function () {
                                        var C = this.getValue().match(i);
                                        if (!C)alert(b.lang.common.invalidHeight);
                                        return !!C;
                                    },
                                    setup: r,
                                    commit: function (C, D, E) {
                                        var F = this.getValue();
                                        if (C == d) {
                                            if (F)D.setStyle('height', CKEDITOR.tools.cssLength(F)); else if (!F && this.isChanged())D.removeStyle('height');
                                ...
                                onLoad: function () {
                                    ...
                                    if (D) {
                                        D.on('click', function (E) {
                                            var J = this;
                                            var F = p(J), G = J.originalElement, H = J.getValueOf('info', 'txtWidth');
                            ...
                            children: [{
                                ...
                                commit: function (C, D, E) {
                                    var F = this.getValue();
                                    if (C == d || C == f) {
                                        if (F)D.setStyle('float', F); else D.removeStyle('float');
                                        if (!E && C == d) {
                ...
                id: 'Link', label: b.lang.link.title, padding: 0, elements: [{
                    id: 'txtUrl',
                    type: 'text',
                    label: b.lang.common.url,
                    style: 'width: 100%',
                    ...
                    type: 'button',
                    id: 'browse',
                    filebrowser: {action: 'Browse', target: 'Link:txtUrl', url: b.config.filebrowserImageBrowseLinkUrl},
                    style: 'float:right',
                    hidden: true,
                    label: b.lang.common.browseServer
                }, {
                ...
                elements: [{
                    ...
                    widths: ['50%', '25%', '25%'],
                    children: [{
                        type: 'text', id: 'linkId', label: b.lang.common.id, setup: function (C, D) {
                    ...
                    type: 'text', id: 'txtGenLongDescr', label: b.lang.common.longDescr, setup: function (C, D) {
                    ...
                    type: 'hbox', widths: ['50%', '50%'], children: [{
                        ...
                        commit: function (C, D) {
                            ...
                            } else if (C == f)D.setAttribute('title', E.getValue()); else if (C == g)D.removeAttribute('title');
                        }
                    }]
                }, {
                    type: 'text',
                    ...
                    setup: function (C, D) {
                        if (C == d) {
                            ...
                            this.attributesInStyle = {height: !!H, width: !!I};
                        }
                    },
                    onChange: function () {
