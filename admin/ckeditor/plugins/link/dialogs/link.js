...
CKEDITOR.dialog.add('link', function (a) {
    ...
    return {
        title: D.title, minWidth: 350, minHeight: 230, contents: [{
            id: 'info',
            label: D.info,
            title: D.info,
            elements: [{
                ...
                label: D.type,
                'default': 'url',
                items: [[D.toUrl, 'url'], [D.toAnchor, 'anchor'], [D.toEmail, 'email']],
                onChange: d,
                setup: function (E) {
                ...
                type: 'vbox', id: 'urlOptions', children: [{
                    type: 'hbox', widths: ['25%', '75%'], children: [{
                        ...
                        label: C.protocol,
                        'default': 'http://',
                        items: [['http://‎', 'http://'], ['https://‎', 'https://'], ['ftp://‎', 'ftp://'], ['news://‎', 'news://'], [D.other, '']],
                        setup: function (E) {
                ...
                children: [{
                    ...
                    html: '<div role="label" tabIndex="-1">' + CKEDITOR.tools.htmlEncode(D.noAnchors) + '</div>',
                    focus: true,
                    setup: function (E) {
            ...
            elements: [{
                ...
                children: [{
                    ...
                    'default': 'notSet',
                    style: 'width : 100%;',
                    items: [[C.notSet, 'notSet'], [D.targetFrame, 'frame'], [D.targetPopup, 'popup'], [C.targetNew, '_blank'], [C.targetTop, '_top'], [C.targetSelf, '_self'], [C.targetParent, '_parent']],
                    onChange: c,
                    setup: function (E) {
                ...
                children: [{
                    type: 'fieldset',
                    label: D.popupFeatures,
                    children: [{
                        type: 'hbox',
                        children: [{
                            type: 'checkbox',
                            id: 'resizable',
                            label: D.popupResizable,
                            setup: r,
                            commit: u
            ...
            elements: [{
                ...
                children: [{
                    type: 'hbox',
                    widths: ['45%', '35%', '20%'],
                    children: [{type: 'text', id: 'advId', label: D.id, setup: s, commit: v}, {
                        type: 'select',
                        id: 'advLangDir',
                        label: D.langDir,
                        'default': '',
                        style: 'width:110px',
                        items: [[C.notSet, ''], [D.langDirLTR, 'ltr'], [D.langDirRTL, 'rtl']],
                        setup: s,
                        commit: v
                    }, {
                        type: 'text',
                    ...
                    type: 'hbox',
                    widths: ['45%', '35%', '20%'],
                    children: [{type: 'text', label: D.name, id: 'advName', setup: s, commit: v}, {
                        type: 'text',
                        label: D.langCode,
                        id: 'advLangCode',
                        width: '110px',
                ...
                children: [{
                    ...
                    type: 'hbox',
                    children: [{type: 'text', label: D.styles, 'default': '', id: 'advStyles', setup: s, commit: v}]
                }]
            }]
        }], onShow: function () {
            var H = this;
