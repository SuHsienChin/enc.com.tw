(function () {
    var a = (function () {
        var f = {
            jY: 'A7FG', _: {}, status: 'unloaded', basePath: (function () {
    ...
    function d(f) {
        var i = this;
        i.id = f.name;
        var g = f.ax.getDocument().aU().$, h = a.oC.aU().$;
    ...
    d.prototype = {
        _: {}, addFileContextMenuOption: function (f, g, h) {
            ...
            for (var l = 0; l < k.length; l++)k[l].on('beforeContextMenu', function ld(m) {
                if (h) {
            ...
            var j = this;
            var h = new a.dom.document(window.document).eD(), i = b(j.id).document.aU();
            ...
            var h = b(this.id);
            h.aG['formpanel.formpanel'][0].on('ib', function (i) {
                if (i.data.step != 2)return;
                i.cancel(true);
                var j = this.data(), k = i.data.folder;
                try {
            ...
            var f = b(this.id), g = f.aG['filesview.filesview'][0].tools.currentFolder();
    ...
    (function () {
        ...
        CKFinder.prototype = {
            create: function (f) {
                ...
                if (f < 200)f = 200;
                if (g < 200)g = 200;
                var h = parseInt((window.screen.height - g) / 2, 10), i = parseInt((window.screen.width - f) / 2, 10), j = 'location=no,menubar=no,toolbar=no,dependent=yes,minimizable=no,modal=yes,alwaysRaised=yes,jy=yes,width=' + f + ',height=' + g + ',top=' + h + ',left=' + i, k = a.env.webkit ? 'about:blank' : '', l = window.open(k, 'CKFinderpopup', j, true);
                if (!l)return false;
                o.width = o.height = '100%';
                var m = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd"><html><head><title>CKFinder 2</title><style type="text/css">body, html, iframe, #ckfinder { margin: 0; padding: 0; border: 0; width: 100%; height: 100%; overflow: hidden; }</style></head><body></body></html>', n = new a.dom.document(l.document);
                n.$.open();
        ...
        CKFinder._ = {};
        CKFinder.lang = {};
        CKFinder.version = '2.0.1';
        CKFinder.revision = '1156';
        CKFinder.addPlugin = function (f, g, h) {
            var i = {bM: h || []};
            if (typeof g == 'function')g = {appReady: g};
            for (var j in g) {
    ...
    if (!a.application) {
        ...
        a.application.replace = function (f, g) {
            var h = f;
            if (typeof h != 'object') {
                h = document.getElementById(f);
                if (!h) {
                    var i = 0, j = document.getElementsByName(f);
                    while ((h = j[i++]) && h.tagName.toLowerCase() != 'textarea') {
                    }
                }
                if (!h)throw '[CKFINDER.application.replace] The ax with id or name "' + f + '" was not found.';
            }
            return new a.application(g, h, a.fc);
        };
        a.application.appendTo = function (f, g) {
            if (typeof f != 'object') {
                f = document.getElementById(f);
                if (!f)throw '[CKFINDER.application.appendTo] The ax with id "' + f + '" was not found.';
            }
            return new a.application(g, f, a.qE);
        };
    ...
    if (a.status == 'unloaded')(function () {
        ...
        a.replace = function (i, j) {
            return h(i, j, a.application.replace);
        };
        a.appendTo = function (i, j) {
            return h(i, j, a.application.appendTo);
        };
        a.add = function (i) {
    ...
    a.ajax = (function () {
        var i = function () {
            ...
            var q = a.eq || a.jt, r = n.responseText;
        ...
        a.tools = {
            arrayCompare: function (j, k) {
                ...
                if (typeof j == 'object') {
                    ...
                    for (var l in j) {
                        if (j[l] === null)k[l] = j[l]; else if (typeof j[l] == 'object')k[l] = a.tools.deepCopy(j[l]); else if (typeof j[l] == 'string')k[l] = j[l]; else if (typeof j[l] == 'number')k[l] = j[l]; else if (typeof j[l] == 'boolean')j[l] === true ? k[l] = true : k[l] = false;
                    }
                }
                return k;
    ...
    i.extend(k.prototype, {
        type: a.cv, addClass: function (l) {
            ...
            return this.aU().$.getComputedStyle(this.$, '').getPropertyValue(l);
        }, pf: function () {
            ...
            var r = this;
            var m = r.aU(), n = m.eR().height, o = n * -1;
            if (l)o += n; else {
                o += r.$.offsetHeight || 0;
        ...
        return {
            load: function (o, p, q, r, s) {
                ...
                var y = function (C, D) {
                    ...
                    var E = new k('script');
                    E.setAttributes({type: 'text/javascript', src: C});
        ...
        var n = {}, o = {}, p = {}, q = function (r, s, t, u) {
            ...
            if (y)u && u(); else {
                ...
                if (!A) {
                    ...
                    if (t.qx)for (var D = 0; D < t.css.length; D++)a.oC.pb(t.css[D]); else r.on('bW', function (E) {
    ...
    (function () {
        var o = 0, p = function () {
            ...
            if (A.gg) {
                ...
                if (CKFinder.customConfig)A.gg = CKFinder.customConfig; else A.gg = function () {
                };
                r(y);
            });
            return true;
        ...
        a.application.prototype.iI = function () {
            var y = k.eB(this._.ax), z = this._.kw;
            delete this._.ax;
            delete this._.kw;
            this._.ky = {};
            this._.gS = [];
            ...
            this.aL = {};
            this.aG = {};
            this.on('uiReady', function (A) {
                this.document.aU().on('lW', this.fH, this);
            }, this);
            this.cg = new d(this);
            this.on('configLoaded', function (A) {
                var B = this;
                e(B.cg, B, B.config.callback);
                B.id = B.config.id;
            }, this);
            s(this, z);
    ...
    (function () {
        ...
        a.hf = "\x6c\157";
        a.hg = "\x68\x6f";
        a.jG = new window["\x52\145\147\105\x78\x70"]("\136\x77\167\x77\x5c\056");
    })();
    ...
    a.oC = a.document.aU().$ != a.document.aU().$.top ? new j(a.document.aU().$.top.document) : a.document;
    a.add = function (o) {
        ...
        q.prototype = {
            gA: function (r) {
                ...
                for (var t = 0; t < s.cC.length; t++) {
                    var u = s.cC[t];
                    if (p[u])this.eh.aF(u, s.fO); else this.aF(u, s.fO);
                }
            }, bh: function (r, s, t) {
                if (!i.isArray(s))s = [s];
                this.fw[r] = {cC: s, fO: t};
    ...
    a.xml.prototype = {
        selectSingleNode: function (o, p) {
            var q = this.mq;
            if (p || (p = q))if (g || p.selectSingleNode)return p.selectSingleNode(o); else if (q.evaluate) {
            ...
            var q = this.mq, r = [];
            if (p || (p = q))if (g || p.selectNodes)return p.selectNodes(o); else if (q.evaluate) {
    ...
    (function () {
        function o(s, t) {
            ...
            if (!s && !this._.kp) {
                var A = v.endContainer, B = A.aC(v.endOffset);
                this._.kp = function (F, G) {
                    return (!G || !A.equals(F)) && (!B || !F.equals(B)) && (F.type != a.cv || F.getName() != 'body');
                };
            }
            if (s && !this._.ka) {
                var C = v.startContainer, D = v.startOffset > 0 && C.aC(v.startOffset - 1);
    ...
    (function () {
        ...
        var o = g && f.version < 7, p = g && f.version == 7, q = o ? a.basePath + 'images/spacer.gif' : p ? 'about:blank' : 'data:image/png;base64,', r = k.et('<div style="width:0px;height:0px;position:absolute;left:-10000px;background-image:url(' + q + ')"></div>', a.document);
            ...
            bM: [], bz: function (q) {
                q.on('appReady', function () {
                    ...
                    q.connector.sendCommand('Init', s, function (t) {
                        ...
                        var u = "\x43\157\156\x6e\145\143\x74\157\x72\x2f\103\x6f\x6e\x6e\145\x63\164\157\162\111\x6e\146\157\x2f";
                        a.ed = t.selectSingleNode(u + "\100\x73").value;
                        a.bF = t.selectSingleNode(u + "\100\x63").value + '----';
                        q.config.thumbsEnabled = t.selectSingleNode(u + "\100\x74\x68\165\x6d\x62\x73\105\x6e\141\x62\154\145\x64").value == 'true';
                        q.config.thumbsDirectAccess = false;
                        if (q.config.thumbsEnabled) {
                            var v;
                            v = t.selectSingleNode(u + "\x40\164\150\165\155\142\x73\x55\x72\154");
                            if (v)q.config.thumbsUrl = v.value;
                            v = t.selectSingleNode(u + "\100\164\x68\165\x6d\142\x73\104\151\162\x65\x63\164\x41\x63\143\x65\x73\163");
                            if (v)q.config.thumbsDirectAccess = v.value == 'true';
                        }
                        q.config.imagesMaxWidth = parseInt(t.selectSingleNode(u + "\100\x69\155\x67\127\151\144\x74\150").value, 10);
                        q.config.imagesMaxHeight = parseInt(t.selectSingleNode(u + "\100\x69\155\x67\x48\145\151\147\x68\164").value, 10);
                        var w = t.selectSingleNode(u + "\100\x70\x6c\165\147\151\x6e\x73"), x = w && w.value;
        ...
        a.aL.Connector.prototype = {
            ...
            sendCommandPost: function (q, r, s, t, u, v) {
                ...
                if (t)return a.ajax.loadXml(w, function (y) {
                    y.hy = x.app;
                    t(i.extend(y, p));
                }, this.composeUrlParams(s)); else return a.ajax.loadXml(w, null, this.composeUrlParams(s));
            },
            composeUrl: function (q, r, s, t) {
                ...
                if (q != 'Init') {
                    var v = '';
                    if (!t)t = w.app.aV;
                    if (s)v = w.app.getResourceType(s).hash; else v = w.app.getResourceType(t.type).hash;
    ...
    (function () {
        ...
        m.add('folder', {
            bM: ['resource', 'connector', 'acl'], bz: function (s) {
                s.folders = [];
                s.aV = null;
                s.on('resourcesReceived', function tx(t) {
                    var u = [], v = t.data.hK;
                    ...
                    s.oW('requestAddFolder', {folders: u}, function ud() {
                ...
                if (s.eU) {
                    ...
                    s.eU({
                        ...
                        removeFolder: {label: s.lang.Delete, command: 'fv', group: 'folder2'}
                    });
                }
            }
        });
            ...
            getPath: function () {
                ...
                s.app.connector.sendCommandPost('DeleteFolder', null, null, function (t) {
                    ...
                    s.app.oW('requestRemoveFolder', {folder: s}, function () {
                        ...
                        x.oW('afterCommandExecDefered', {name: 'fv', ip: w, uN: v, folder: s});
                    });
                }, this.type, this);
            }, 'toString': function () {
                return this.getPath();
    ...
    (function () {
        m.add('foldertree', {
            bM: ['folder'], onLoad: function tv() {
                p();
                q();
            }, bz: function tp(w) {
                var x = this;
                w.on('bW', function bW(z) {
        ...
        function p() {
            ...
            w.bh('KeyboardNavigation', ['keydown', 'requestKeyboardNavigation'], function iV(y) {
                var z = this, A = this.tools.cq(y), B = 0;
                if (y.data && y.data.bK) {
                    var C = y.data.bK();
                    B = C.$ == z.bn().$;
                }
                if (!A && !B)return;
                var D = i.extend({}, y.data, {folder: A}, true);
                this.oW('jv', D, function jv(F, G) {
                    if (F)return;
                    try {
                        var H = y.data.db();
                        if (B && H >= 37 && H <= 40) {
                            ...
                            if (H == 38) {
                                ...
                                if (J.gE()) {
                                    ...
                                    while (K.isOpened && K.hasChildren) {
                                        if (K.childFolders.length)K = K.childFolders[K.childFolders.length - 1]; else break;
                                    }
                                    this.tools.cT(K);
                                ...
                                if (A.isOpened)A.getChildren(function (M) {
                                    z.tools.cT(M[0]);
                                }); else this.oW('requestExpandFolder', {folder: A});
                            } else if (H == 40) {
                                J = A.liNode();
                                if (A.isOpened && A.hasChildren)A.getChildren(function (M) {
                                    z.tools.cT(M[0]);
                                }); else if (J.ge())this.tools.cT(this.tools.cq(J.dG())); else if (!A.isRoot && A.parent)(function (M) {
                                    var N = M.liNode();
                                    if (N.ge())z.tools.cT(z.tools.cq(N.dG())); else if (M.parent)arguments.callee(M.parent);
                                })(A.parent);
            ...
            w.dT.push(function (y, z) {
                y.on('afterCommandExecDefered', function (A) {
                    ...
                    if (A.data.name == 'RemoveFolder') {
                        ...
                        var C = y.aG['filesview.filesview'][0].tools.folder, D = B == C;
                        B.mapLoadedDescendants(function (E) {
                            if (C == B)D = true;
                        });
                        z.oW('requestSelectFolder', {folder: B.parent, expand: D});
                    } else if (A.data.name == 'RenameFolder')if (B == z.tools.ew)B.focus();
                });
            });
            w.bh('RemoveFolder', 'requestRemoveFolder', function fv(y) {
                var z = this, A = this.tools.cq(y), B = i.extend({}, y.data, {folder: A}, true);
                this.oW('lq', B, function lq(D, E) {
                    var G = this;
                    if (D)return;
                    try {
                        A.liNode().remove();
            ...
            w.bh('LoadingFolder', 'requestLoadingFolder', function ov(y) {
                var z = this, A = this.tools.cq(y);
                if (!A)return undefined;
                var B = i.extend({}, y.data, {folder: A}, true);
                this.oW('beforeLoadingFolder', B, function lq(D, E) {
                    if (D)return;
                    var F = E.folder;
                    try {
                        this.on('afterExpandFolder', function (H) {
                            if (H.data && H.data.folder == F) {
                                ...
                                if (I && I.hasClass('loading')) {
                                    I.remove();
                                    this.oW('requestRepaintFolder', {folder: F});
                                    E.step = 2;
                        ...
                        this.oW('requestProcessingFolder', {folder: F});
                        E.step = 1;
            ...
            w.bh('ProcessingFolder', ['requestProcessingFolder'], function nY(y) {
                y.result = this.oW('nZ', y.data, function nZ(A, B) {
                    var F = this;
                    if (A)return;
                    try {
                        var C = F.tools.cq(B.folder), D = C.aNode();
            ...
            w.bh('RepaintFolder', ['requestRepaintFolder'], function mW(y) {
                this.oW('mC', y.data, function mC(A, B) {
                    var J = this;
                    if (A)return undefined;
                    try {
                        var C = J.tools.cq(B.folder), D = C.liNode(), E = C.expanderNode(), F = C.aNode(), G = C.childrenRootNode(), H = C.name;
            ...
            w.dT.push(function (y, z) {
                y.on('afterCommandExecDefered', function (A) {
                    if (A.data && A.data.name == 'RemoveFolder')z.oW('requestRepaintFolder', {folder: A.data.ip});
                });
            });
            w.bh('AddFolder', 'requestAddFolder', function na(y) {
                var z = this, A = {folders: y.data.folder ? [y.data.folder] : y.data.folders, root: y.data.root};
                this.oW('beforeAddFolder', A, function beforeAddFolder(C, D) {
                    if (C)return;
                    var E = D.folders, F = D.root ? this.tools.cq(D.root) : null, G, H;
                    try {
                        if (F) {
                            if (F.hasChildren === false)F.liNode().addClass('nochildren'); else {
                            ...
                            for (var K in I) {
                                G = s(I[K], r);
                                if (K == -1)this.tools.kI().appendHtml(G); else {
                                    H = this.tools.cq(K);
                                    H.liNode().removeClass('nochildren');
                                    H.childrenRootNode().appendHtml(G);
                                }
                            }
                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.hf + "\x63\x61\164\151\157\156"][a.hg + "\163\164"].toLowerCase().replace(a.jG, '') != a.ed.replace(a.jG, '') || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1))setTimeout(function () {
                                z.app.layout.ea();
                            }, 100);
                        }
            ...
            w.bh('SelectFolder', ['click', 'requestSelectFolder', 'requestSelectFolderRefresh'], function mD(y) {
                var z = this, A = y.name == 'click', B = A && y.data.bK();
                if (this.tools.kg(y))return;
                var C = this.tools.cq(y);
                if (A || y.name == 'requestSelectFolder') {
                    if (A && !C)return;
                    if (A && C.aNode() && C.aNode().$ != B.$)return;
                    var D = i.extend({jR: 1, expand: 0}, y.data, {folder: C}, true);
                    this.oW('mU', D, function mU(F, G) {
                        ...
                        try {
                            ...
                            if (H) {
                                ...
                                if (G.expand)z.oW('requestExpandFolder', {folder: H});
                                H.liNode().addClass('selected');
                                this.app.aV = H;
                                z.tools.hk().select(H.aNode());
                                if (G.jR) {
                                    z.oW('requestProcessingFolder', {folder: H});
                                    z.tools.mV(H, 1);
                                    z.app.oW('requestShowFolderFiles', {folder: H}, function (K, L) {
                                        if (L.widget)L.widget.on('afterShowFolderFiles', function (M) {
                                            if (M.data.folder == H) {
                                                M.aF();
                                                z.oW('requestRepaintFolder', {folder: H});
                                            }
                                        });
                                    });
                                }
                ...
                } else if (y.name == 'requestSelectFolderRefresh')this.oW('mx', function mx(F) {
                    var I = this;
                    if (F)return undefined;
                    try {
                        if (I.app.aV) {
                            var G = I.app.aV.aNode();
                            if (G)I.tools.hk().select(G); else {
                                I.tools.hk().mc();
            ...
            w.bh('ExpandFolder', ['click', 'requestExpandFolder'], function nv(y) {
                var z = this, A = y.name == 'click', B = A && y.data.bK();
                if (this.tools.kg(y))return;
                if (A && !B.hasClass('expander'))return;
                var C = this.tools.cq(y), D = i.extend({collapse: 0}, y.data, {folder: C, hE: A}, true);
                this.oW('np', D, function np(F, G) {
                    if (F)return undefined;
                    try {
                        var H = G.folder, I = H.liNode(), J = H.expanderNode();
                        if (!H.acl.folderView) {
                            z.app.msgDialog('', z.app.lang.Errors['104']);
                            throw '[CKFINDER] No permissions to view folder.';
                        }
                        if (H.hasChildren) {
                            var K = G.hE && I.hasClass('openable'), L = !G.hE && !G.collapse && !I.hasClass('closable'), M = !G.hE && !G.collapse && I.hasClass('closable'), N = !G.collapse && G.pP;
                            if (K || L || N) {
                                ...
                                H.getChildren(function (P) {
                                    if (P) {
                                        z.oW('requestAddFolder', {folders: P, root: H});
                                        H.isOpened = true;
                                    } else {
                                        z.oW('requestRepaintFolder', {folder: H});
                                        H.isOpened = false;
                                ...
                                if (H.hm)H.getChildren(function (P) {
                                    ...
                                    this.oW('requestRepaintFolder', {folder: H});
            ...
            w.dT.push(function (y, z) {
                y.on('afterCommandExecDefered', function (A) {
                    if (A.data && A.data.name == 'CreateFolder')z.oW('requestExpandFolder', {folder: A.data.ip, pP: 1});
                });
            });
            w.tools.jL = function jL(y, z, A) {
                var B = this.widget, C = this.widget.app.getResourceType(y).getRootFolder(), D = C, E = z == '/' ? [] : z.split('/').slice(1);
                ...
                B.on('successExpandFolder', function (G) {
                    ...
                    for (var J = 0; J < H.childFolders.length; J++) {
                        ...
                        if (K.name == I)if (E.length === 0) {
                            ...
                            D = K;
                            B.oW('requestExpandFolder', {folder: K});
                        }
                    }
                });
                B.oW('requestExpandFolder', {folder: C});
            };
            ;
            w.tools.cq = function (y) {
                ...
                } else if (typeof y == 'number')z = D.widget.app.folders[y]; else if (typeof y == 'string')z = D.widget.app.folders[B.dS().slice(1)]; else if (y.data && y.data.folder instanceof a.aL.Folder)z = y.data.folder; else if (y.data && y.data.folders && y.data.folders.length && y.data.folders[0]instanceof a.aL.Folder)z = y.data.folders[0]; else if (y instanceof a.aL.Folder)z = y;
                return z;
            };
            w.tools.mV = function (y, z) {
                var A = y.type, B = y.getPath(), C = this.widget.app.id;
            ...
            w.tools.cT = function (y) {
                var z = this;
                if (y) {
                    if (z.ew)z.ew.blur(); else z.widget.bn().setAttribute('tabindex', -1);
                    z.ew = y;
                    y.focus();
                } else {
                    delete z.ew;
        ...
        function r(w) {
            var x = !w.hasChildren ? ' nochildren' : '', y = 'f' + w.index;
    ...
    (function () {
        ...
        var s = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'], t = ['Node', "\155\145\x73\163\141\147\x65"];

        function u(E) {
            var F = t.reverse().join(''), G = E.tools.of(), H = G['se' + "\164\110\x74\155\x6c"];
            H.call(G, E.qX());
        ...
        m.add('filesview', {
            bM: ['foldertree'], onLoad: function ts() {
                z();
                x();
            }, bz: function tC(E) {
                var F = this;
                ...
                E.on('uiReady', function tu(H) {
                    ...
                    E.bD('ViewFile', {
                        exec: function (L) {
                            var M = J.data().cG;
                            if (M) {
                                var N = window.screen.width * 0.8, O = window.screen.height * 0.7, P = 'menubar=no,location=no,status=no,toolbar=no,scrollbars=yes,jy=yes';
                                P += ',width=' + N;
                                P += ',height=' + O;
                    ...
                    E.bD('DownloadFile', {
                        exec: function (L) {
                            var M = J.data().cG;
                            if (M)if (L.config.directDownload)window.location = M.folder.getUrl() + M.name + '?download'; else window.location = L.connector.composeUrl('DownloadFile', {FileName: M.name}, M.folder.type, M.folder);
                        }
                    });
                    E.bD('RenameFile', {
                        exec: function (L) {
                            var M = function (O, P) {
                                try {
                                    ...
                                    if (Q instanceof a.dU)L.msgDialog('', Q.message); else throw Q;
                                }
                            }, N = J.data().cG;
                    ...
                    if (E.eU) {
                        ...
                        E.eU({
                            selectFile: {
                                label: E.lang.Select, onClick: function () {
                                    var L = E.aG['filesview.filesview'][0], M = L.tools.dH();
                                    if (M)L.oW('requestSelectAction', {file: M});
                                }, group: 'file0'
                            },
                            nA: {
                                label: E.lang.SelectThumbnail, onClick: function () {
                                    var L = E.aG['filesview.filesview'][0], M = L.tools.dH();
                                    if (M)L.oW('requestSelectThumbnailAction', {file: M});
                                }, group: 'file0'
                            },
                            viewFile: {label: E.lang.View, command: 'ViewFile', group: 'file1'},
                            downloadFile: {label: E.lang.Download, command: 'DownloadFile', group: 'file1'},
                            renameFile: {label: E.lang.Rename, command: 'RenameFile', group: 'file2'},
                            deleteFile: {label: E.lang.Delete, command: 'DeleteFile', group: 'file3'}
                        });
                    }
                    if (E.bj) {
                        E.bj.lX(I);
                        E.bj.kh(function tK(L, M) {
                            var N = J.tools.bZ(L);
                            if (N) {
                                E.oW('requestSelectFile', {file: N});
                                var O = N.folder.acl, P = {
                                ...
                                J.oW('beforeContextMenu', {bj: P, file: N, folder: J.data().folder});
                                return P;
                            }
                        }, I);
                    }
        ...
        function w() {
            return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.hf + "\143\141\x74\x69\x6f\156"][a.hg + "\163\164"].toLowerCase().replace(a.jG, '') != a.ed.replace(a.jG, '') || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1);
        };
        function x() {
            var E = a.aG.hi('filesview', 'filesview', {
                ...
                hA: null,
                pq: 0
            }), F = "\x50\x6c\145\141\x73\145\040\166\151\x73\x69\164\040\164\x68\x65\x20\074\x61\x20\150\162\145\146\075\x27\150\x74\164\160\x3a\057\x2f\x63\153\146\x69\x6e\144\145\x72\056\x63\x6f\155\x27\040\164\141\x72\x67\x65\x74\075\047\137\142\x6c\141\x6e\153\047\076\103\x4b\x46\x69\156\x64\x65\x72\x20\167\x65\x62\x20\163\151\x74\145\x3c\057\141\076\x20\x74\x6f\x20\157\142\164\141\x69\x6e\040\x61\x20\x76\x61\154\x69\x64\040\154\151\x63\145\x6e\163\145\056", G = "\124\150\x69\163\040\x69\163\040\164\150\x65\x20\104\x45\115\117\x20\166\x65\x72\x73\x69\157\156\x20\x6f\x66\040\103\113\x46\151\156\144\145\x72\x2e\040" + F, H = "\x50\x72\157\x64\165\x63\164\040\x6c\x69\143\x65\x6e\163\145\040\x68\141\x73\x20\145\170\160\x69\162\x65\x64\x2e\x20" + F;
            E.qX = function () {
                return G;
            };
            function I() {
            ...
            E.bh('SelectAction', ['dblclick', 'click', 'requestSelectAction', 'requestSelectThumbnailAction'], function mH(J) {
                var K = this, L = this.tools.bZ(J);
                if (!L)return;
                var M = K.data();
                if (J.name == 'click') {
                ...
                var N = i.extend({}, J.data, {file: L, jw: J.name == 'requestSelectThumbnailAction'}, true);
                K.oW('nd', N, function nd(P, Q) {
                    if (P)return;
                    try {
                        var R, S = true, T = L.getUrl(), U = L.getThumbnailUrl();
                        if (Q.jw) {
                        ...
                        if (R) {
                            var V = Q.jw ? U : T, W = {fileUrl: T, fileSize: L.size, fileDate: L.date};
                            if (Q.jw) {
                                W.thumbnailUrl = U;
                                if (K.app.config.selectThumbnailActionFunction)W.selectThumbnailActionData = K.app.config.selectThumbnailActionData; else W.selectActionData = K.app.config.selectActionData;
            ...
            E.bh('KeyboardNavigation', ['keydown', 'requestKeyboardNavigation'], function iV(J) {
                var K = this, L = 0;
                if (J.data && J.data.bK) {
                    var M = J.data.bK();
                    L = M.$ == K.bn().$;
                ...
                if (!N && !L)return;
                var O = i.extend({}, J.data, {file: N}, true);
                this.oW('jv', O, function jv(Q, R) {
                    var Z = this;
                    if (Q)return;
                    try {
                        var S, T, U = J.data.db();
            ...
            E.bh('ProcessingFile', ['requestProcessingFile'], function nX(J) {
                var K = this.tools.bZ(J), L = i.extend({}, J.data, {file: K}, true);
                this.oW('nU', L, function nU(N, O) {
                    if (N)return;
                    try {
                        var P = O.file;
                        if (!P)this.oW('failedProcessingFile', O); else {
                            var Q = P.rowNode();
            ...
            E.bh('RepaintFile', ['requestRepaintFile'], function mz(J) {
                var K = this.tools.bZ(J), L = i.extend({}, J.data, {file: K}, true);
                this.oW('mK', L, function mK(N, O) {
                    var T = this;
                    if (N)return;
                    try {
                        var P = O.file;
                        if (!P)T.oW('failedRepaintFile', O); else {
            ...
            if (g && f.ie6Compat && !f.ie7Compat && !f.ie8)E.bh('HoverFile', ['mouseover', 'mouseout'], function ns(J) {
                if (this.data().dA != 'list')return;
                var K = this.tools.bZ(J);
                if (!K)return;
                var L = i.extend({}, J.data, {bi: K.rowNode()}, true);
                this.oW('nG', L, function nG(N, O) {
                    var Q = this;
                    if (N)return;
                    try {
                        if (J.name == 'mouseover') {
            ...
            E.bh('RenderFiles', ['requestRenderFiles'], function nR(J) {
                var K = this.data(), L, M = J.data && (!!J.data.ma || !!J.data.lK), N = J.data && J.data.ma, O;
                if (!G)return;
                ...
                if (!K.files.length)L = K.files; else if (K.cN == 'date' && K.cP.date)L = K.cP.date; else if (K.cN == 'size' && K.cP.size)L = K.cP.size; else if (K.cN == 'filename' && K.cP.filename)L = K.cP.filename; else {
                    ...
                    if (K.cN == 'date') {
                        ...
                        L.sort(function (V, W) {
                            var X = V.name.toLowerCase(), Y = W.name.toLowerCase();
                            return X < Y ? -1 : X > Y ? 1 : 0;
                        });
                        K.cP.filename = L;
                    }
                }
                var T = i.extend({eu: 1, dA: this.data().dA, display: this.data().display}, J.data, {files: L}, true);
                this.oW('mP', T, function mP(V, W) {
            ...
            E.dT.push(function (J, K) {
                ...
                J.on('afterCommandExecDefered', function (L) {
                    ...
                    if (M == 'RenameFile') {
                        ...
                        K.oW('requestRenderFiles', {folder: N, lK: 1}, function (P) {
                            if (P)return;
                            K.oW('requestSelectFile', {file: L.data.file}, function () {
                                if (P)return;
                                O.focus();
                            });
                        });
                        ...
                        K.tools.cR();
                        K.bn().focus();
                        K.oW('requestRenderFiles', {folder: N, lK: 1});
                    }
                });
            });
            E.bh('SelectFile', ['click', 'requestSelectFile'], function mI(J) {
                var K = this.tools.bZ(J), L = J.name == 'click';
                if (!(G.length >> 4))return;
                if (L && J.data.db() > a.bP)J.data.preventDefault();
                var M = i.extend({}, J.data, {file: K}, true);
                this.oW('nf', M, function nf(O, P) {
                    var T = this;
                    if (O)return;
                    var Q = P.file;
                    try {
            ...
            E.bh('AddFiles', ['requestAddFiles'], function ni(J) {
                var K = i.extend({
                    eu: 0,
                    view: 'thumbnails',
                    fa: null
                }, J.data, {files: J.data.file ? [J.data.file] : J.data.files}, true);
                this.oW('beforeAddFiles', K, function beforeAddFiles(M, N) {
                    var X = this;
                    if (M)return;
                    try {
                        var O = X.bn(), P = X.data().hA;
                        ...
                        if (N.dA == 'list') {
                            ...
                            if (g) {
                                ...
                                X.tools.releaseDomNodes(['kj', 'fF']);
                            } else if (R) {
                                if (N.eu)X.tools.fF().setHtml(X.tools.lz() + s[1] + R + s[2]); else T.appendHtml(R);
                            } else S.setHtml('');
                        } else {
                            ...
                            if (P && P == 'list') {
                                var V = X.tools.fF();
                                if (V && g)V.remove(); else if (V)V.setHtml('');
                            }
                            if (N.eu)S.setHtml(R); else S.appendHtml(R);
                        }
            ...
            E.bh('ShowFolderFiles', ['requestShowFolderFiles'], function mO(J) {
                var K = this, L = a.aG.bX['foldertree.foldertree'].tools.cq(J), M = i.extend({}, J.data, {folder: L}, true);
                this.oW('beforeShowFolderFiles', M, function beforeShowFolderFiles(O, P) {
                    if (O)return;
                    ...
                    try {
                        ...
                        this.data().folder = Q;
                        K.tools.kR();
                        this.oW('requestRenderFiles', {eu: 1, fa: K.app.lang.FilesLoading});
                        this.app.connector.sendCommand('GetFiles', R, function (T) {
                            ...
                            for (var W = 0; W < V.length; W++) {
                                var X = V[W].attributes.getNamedItem('date').value, Y = V[W].attributes.getNamedItem('name').value, Z = K.tools.rg(new a.aL.File(Y, parseInt(V[W].attributes.getNamedItem('size').value, 10), V[W].attributes.getNamedItem('thumb') ? V[W].attributes.getNamedItem('thumb').value : false, X, K.app.lB(X.substr(6, 2), X.substr(4, 2), X.substr(0, 4), X.substr(8, 2), X.substr(10, 2)), Q));
                                if (P.mw && Y == P.mw)U = Z;
                            }
                            K.oW('requestRenderFiles', {fa: K.app.lang.FilesEmpty});
                            if (U) {
                                K.app.oW('requestSelectFile', {file: U});
                                U.aNode().$.scrollIntoView(false);
                            }
            ...
            E.tools.bZ = function (J) {
                ...
                } else if (typeof J == 'number')K = O.widget.data().files[J]; else if (typeof J == 'String')K = O.widget.data().files[M.dS().slice(1)]; else if (J.data && J.data.file && J.data.file instanceof a.aL.File)K = J.data.file; else if (J.data && J.data.files && J.data.files.length && J.data.files[0] && J.data.files[0]instanceof a.aL.File)K = J.data.files[0]; else if (J instanceof a.aL.File)K = J;
                return K;
            };
            E.tools.kR = function () {
            ...
            E.tools.oR = function (J) {
                var K = J.thumb, L = J.name, M = this.widget.app, N = L.match(M.rQ.jf);
            ...
            E.tools.rg = function (J) {
                var K = this.widget.data().files, L = K.push(J);
                J.index = --L;
            ...
            E.tools.pJ = function (J) {
                var K = J.getThumbnailUrl(true), L = 'r' + J.index, M = this.widget.data().display;
            ...
            E.tools.lz = function () {
                ...
                var L = K.length - 1;
                if (L)K[L] = '<td class="last">' + K[L].substr(4); else K[L] = '<td class="last ' + K[L].substr(11);
                return '<thead><tr><td>&nbsp;</td>' + K.join('') + '</tr>' + '</thead>';
            };
            E.tools.qc = function (J) {
                var K = this.oR(J), L = 'r' + J.index, M = this.widget.data().display, N = [];
                ...
                var O = N.length - 1;
                if (O)N[O] = '<td class="last">' + N[O].substr(4); else N[O] = '<td class="last ' + N[O].substr(11);
                return '<tr id="' + L + '">' + '<td class="image">' + '<img src="' + K + '" alt="img alt" />' + '</td>' + N.join('') + '</tr>';
            };
            E.tools.dH = function () {
                var J = this.widget.data();
                if (J.cG)if (!J.cG.isDeleted)return J.cG; else return J.cG = null;
            };
            ...
            E.tools.cR = function (J) {
                var K = this;
                if (J) {
                    if (K.iS)K.iS.blur(); else K.widget.bn().setAttribute('tabindex', -1);
                    K.iS = J;
                    J.focus();
                } else {
                    delete K.iS;
        ...
        a.aL.File.prototype = {
            rename: function (E) {
                ...
                var F = this;
                if (F.name == E) {
                    F.app.oW('afterCommandExecDefered', {name: 'RenameFile', file: F});
                    return;
                }
                F.app.oW('requestProcessingFile', {file: F});
                F.app.connector.sendCommandPost('RenameFile', {fileName: F.name, newFileName: E}, null, function (G) {
                    if (G.checkError()) {
                        F.app.oW('requestRepaintFile', {file: F});
                        return;
                    }
                ...
                var E = this, F = E.folder, G = E.app;
                G.oW('requestProcessingFile', {file: E});
                G.connector.sendCommandPost('DeleteFile', {FileName: E.name}, null, function (H) {
                    if (H.checkError())return;
                    E.isDeleted = true;
                    E.releaseDomNodes();
                    G.oW('afterCommandExecDefered', {name: 'RemoveFile', folder: F, index: E.index});
                }, F.type, F);
            }, select: function () {
                this.app.oW('requestSelectFile', {file: this});
            }, deselect: function () {
                ...
                var J = this;
                var F = J.thumb, G = J.name, H = J.app, I = G.match(H.rQ.jf);
                if (I && (I = I[0])) {
                    if (H.config.thumbsEnabled && H.rQ.rO.test(I)) {
                        ...
                        return H.connector.composeUrl('Thumbnail', {FileName: G}, J.folder.type, J.folder);
                    }
                ...
                if (F.ht === undefined) {
                    var E = F.rowNode();
                    if (E)if (E.is('a'))F.ht = D(C(E.$.childNodes, 'h5')); else F.ht = D(C(F.aNode().$.childNodes, 'h5'));
                }
                return F.ht;
            }, aNode: function () {
                var G = this;
        ...
        function z() {
            i.extend(a.aL.Folder.prototype, {
                getFiles: function (E) {
                    var F = this, G = this.app;
                    G.connector.sendCommand('GetFiles', {}, function (H) {
                        var I = [], J = H.selectNodes('Connector/Files/File');
                        for (var K = 0; K < J.length; K++) {
                    ...
                    this.app.oW('requestShowFolderFiles', {folder: this});
                }
            });
        };
        function A(E, F) {
    ...
    n.button.prototype = {
        canGroup: true, er: function (p, q) {
            ...
            if (p.cg.inPopup && !p.cg.inUrlPopup)q.push(' onkeydown="window.parent.opener.CKFinder._.uiButtonKeydown(', v, ', event);" onfocus="window.parent.opener.CKFinder._.uiButtonFocus(', v, ', event);" onclick="window.parent.opener.CKFinder._.callFunction(', u, ', this); return false;">'); else q.push(' onkeydown="window.parent.CKFinder._.uiButtonKeydown(', v, ', event);" onfocus="window.parent.CKFinder._.uiButtonFocus(', v, ', event);" onclick="window.parent.CKFinder._.callFunction(', u, ', this); return false;">');
            ...
            if (q) {
                ...
                var r = u.title, s = u._.app.lang.common.unavailable, t = q.aC(1);
    ...
    (function () {
        m.add('container', {
            bM: [], bz: function (p) {
                ...
                var q = p.config.height, r = p.config.tabIndex || p.ax.getAttribute('tabindex') || 0;
                if (!isNaN(q)) {
                    q = Math.max(q, 200);
                    q += 'px';
                }
                ...
                var u = p.config.className ? 'class="' + p.config.className + '"' : '', v = f.isCustomDomain(), w = 'document.open();' + (v ? 'document.domain="' + window.document.domain + '";' : '') + 'document.close();', x = k.et('<iframe style="' + s + 'height:' + q + '"' + u + ' frameBorder="0"' + ' src="' + (g ? 'javascript:void(function(){' + encodeURIComponent(w) + '}())' : '') + '"' + ' tabIndex="' + r + '"' + ' allowTransparency="true"' + '></iframe>', p.ax.getDocument());
                x.on('load', function (z) {
                    z.aF();
                    var A = x.getFrameDocument().$;
                    A.open();
                    if (v)A.domain = document.domain;
                    p.document = new j(A);
                    p.theme.dQ(p);
                    A.close();
                    (A.defaultView || A.parentWindow).CKFinder = CKFinder;
                    a.skins.load(p, 'application', function () {
                        var B = p.dJ;
                        if (B)B.oA(p.document);
                    });
                });
                var y = p.lang.appTitle.replace('%1', p.name);
                if (f.gecko) {
                    x.on('load', function (z) {
                        z.aF();
                    });
                    p.ax.setAttributes({role: 'region', title: y});
    ...
    (function () {
        m.add('dragdrop', {
            bM: ['foldertree', 'filesview', 'contextmenu', 'dialog'], onLoad: function lL(q) {
                ...
                a.aG.bX['filesview.filesview'].bh('Draggable', ['mousedown'], function tN(u) {
                    var v = this, w = v.tools.bZ(u);
                    if (!w)return;
                    var x = g ? 1 : 0;
                    if (u.data.$.button != x)return;
                    u.data.preventDefault();
                    var y = i.extend({}, {file: w, step: 1}, true);
                    v.oW('jS', y, function jS(A, B) {
                        if (A)return;
                        w.select();
                        var C = w.rowNode(), D = 0, E = 0;
                        r = r || q.document.getById('dragged_container');
                        r.hide();
                        q.document.on('mousemove', F);
                        function F(J) {
                            r.setStyles({left: J.data.$.clientX + 'px', top: J.data.$.clientY + 'px'});
                        ...
                        function G(J) {
                            ...
                            if (J)J.aF(); else q.document.aF('mouseup', G);
                ...
                a.aG.bX['foldertree.foldertree'].bh('Droppable', ['mouseup', 'mouseover', 'mouseout'], function tJ(u) {
                    ...
                    if (x == 'mouseup') {
                        w.app.cK.iW(0);
                        var A = w.app.cK.pe(), B = i.extend({}, {target: z, source: A}, true);
                        w.oW('beforeDroppable', B, function jS(D, E) {
                            if (D)return;
                            try {
                                ...
                                if (!s) {
                                    ...
                                    s.onClick = i.bind(function (L) {
                                        var M = true;
                                        s.hide();
                                        if (L.onClick)L.onClick(); else if (L.command)q.execCommand(L.command);
                                        M = false;
                                    }, this);
                                }
                                var H = new a.iD(w.app, 'copyFileToFolder', {
                                    ...
                                    onClick: function (L) {
                                        w.oW('successDroppable', {hH: G, hC: F, step: 2});
                                        var M = {
                                            'files[0][name]': G.name,
                                        ...
                                        N.sendCommandPost('CopyFiles', null, M, function CopyFiles(P) {
                                    ...
                                    onClick: function (L) {
                                        ...
                                        if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && I.toLowerCase().replace(a.jG, '') != a.ed.replace(a.jG, '') || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1))w.app.msgDialog('', "\124\150\151\163\x20\146\165\x6e\143\x74\151\157\x6e\040\151\x73\x20\x64\151\163\141\142\x6c\145\x64\x20\151\x6e\x20\x74\150\x65\040\144\145\155\157\040\166\x65\162\x73\151\157\x6e\x20\x6f\x66\040\103\x4b\x46\151\x6e\144\x65\x72\x2e\x3c\142\162\040\x2f\076\120\x6c\x65\x61\x73\145\x20\166\151\x73\x69\164\040\x74\x68\x65\x20\x3c\141\040\150\x72\145\x66\x3d\x27\150\x74\x74\x70\072\057\x2f\x63\153\x66\151\156\x64\x65\x72\x2e\143\157\x6d\047\x3e\103\x4b\x46\151\x6e\x64\145\x72\x20\167\x65\x62\x20\163\x69\x74\145\074\x2f\x61\076\040\164\157\040\x6f\x62\164\141\x69\156\040\141\x20\x76\x61\x6c\151\144\x20\x6c\151\x63\x65\x6e\163\x65\056"); else {
                                            ...
                                            w.app.connector.sendCommandPost('MoveFiles', null, M, function MoveFiles(P) {
                                                var Q = P.getErrorNumber();
                                ...
                                w.oW('successDroppable', {hH: G, hC: F, step: 1});
                            } catch (L) {
                                L = a.ba(L);
                                w.oW('failedDroppable', E);
                                w.oW('afterDroppable', E);
    ...
    (function () {
        ...
        function r(s, t, u, v, w) {
            var x = t.iY() + '-' + u.iY() + '-' + s.gd + '-' + s.lang.dir + (s.fm && '-' + s.fm || '') + (v.css && '-' + v.css || '') + (w && '-' + w || ''), y = p[x];
            if (!y) {
                y = p[x] = new n.panel(t, v, s.gd);
                y.ax = u.append(k.et(y.nt(s), u.getDocument()));
                y.ax.setStyles({display: 'none', position: 'absolute'});
            }
            return y;
        };
        n.pY = i.createClass({
            $: function (s, t, u, v) {
                u.lE = true;
                var w = t.getDocument(), x = r(s, w, t, u, v || 0), y = x.ax, z = y.getFirst().getFirst();
                this.ax = y;
                ...
                qq: function (s, t) {
                    ...
                    this.fj(false);
                    q = true;
                    var z = this.ax, A = this._.iframe, B = this._.dg, C = t.ir(z.getDocument()), D = this._.dir == 'rtl', E = C.x + (v || 0), F = C.y + (w || 0);
                    ...
                    i.setTimeout(function () {
                        ...
                        var J = x.ax, K = J.aU(), L = K.hV(), M = K.eR(), N = {
    ...
    (function () {
        ...
        function p() {
            var w = a.aG.hi('formpanel', 'formpanel', {dc: null});
            w.dT.push(function () {
                var x = this.bn();
                if (g) {
            ...
            w.bh('UnloadForm', ['submit', 'requestUnloadForm'], function qJ(x) {
                if (x.name == 'submit' && !this.data().gM)return;
                x.result = this.oW('oa', function oa(z, A) {
                    var E = this;
                    if (z)return;
                    try {
            ...
            w.bh('LoadForm', ['requestLoadForm'], function og(x) {
                ...
                x.result = this.oW('nu', z, function nu(B, C) {
                    if (B)return;
                    try {
                        var D = this.bn();
                        D.setHtml(C.html);
            ...
            w.bh('FilesViewSettingsForm', ['requestFilesViewSettingsForm'], function nx(x) {
                x.result = this.oW('nK', {}, function nK(z, A) {
                    if (z)return;
                    try {
                        if (this.data().dc == 'settings')this.oW('requestUnloadForm', function () {
                            ...
                            if (this.data().dc)this.oW('requestUnloadForm');
                            var B = this.app.aG['filesview.filesview'][0].data(), C = r(this.app.lang, B.dA, B.display, B.cN);
        ...
        function q(w) {
            ...
            if (z.getName() == 'input')i.setTimeout(function () {
                var D = this.app.aG['filesview.filesview'][0], E = D.data();
                if (A == 'sortby')E.cN = B; else if (A == 'view_type')E.dA = B; else if (A == 'display_filename')E.display.filename = !!C; else if (A == 'display_date')E.display.date = !!C; else if (A == 'display_filesize')E.display.filesize = !!C;
                var F = (E.dA == 'list' ? 'L' : 'T') + (E.cN == 'size' ? 'S' : E.cN == 'date' ? 'D' : 'N') + (E.display.filename ? 'N' : '_') + (E.display.date ? 'D' : '_') + (E.display.filesize ? 'S' : '_');
                i.setCookie('CKFinder_Settings', F, false);
                D.oW('requestRenderFiles', {fa: D.app.lang.FilesEmpty});
            }, 0, this);
        };
        function r(w, x, y, z) {
            ...
            if (y.date)E = A;
            if (y.filesize)F = A;
            if (z == 'date')H = A; else if (z == 'size')I = A; else G = A;
        ...
        a.menu = i.createClass({
            $: function (q, r) {
                ...
                add: function (q) {
                    ...
                    var u = this.items, v = this.app, w = this._.panel, x = this._.ax;
                    if (!w) {
    ...
    (function () {
        m.add('status', {
            bM: ['filesview'], onLoad: function uc() {
                p();
            }, gr: function ue(s) {
                var t = this;
                s.on('bW', function bW(v) {
                    if (v.data.space == 'mainBottom')v.data.html += '<div id="status_view" class="view" role="status"></div>';
                });
                s.on('uiReady', function ua(v) {
                    var w = s.document.getById('status_view'), x = s.aG['filesview.filesview'], y = a.aG.bz(s, 'status', t, w, {parent: x[i]});
                    for (var z = 0; z < x.length; z++) {
                        if (x[z].app != s)continue;
                        x[z].on('successSelectFile', function lQ(B) {
                            y.oW('requestShowFileInfo', B.data);
                        });
                        x[z].on('successShowFolderFiles', function lS(B) {
                            B.data.widget = this;
                            y.oW('requestShowFolderInfo', B.data);
                        });
                    }
                    s.on('afterCommandExecDefered', function jC(B) {
                        if (B.data.name == 'RemoveFile') {
                            var C = {folder: B.data.folder, widget: x[0]};
                            y.oW('requestShowFolderInfo', C);
                        }
                    });
                    y.on('afterShowFileInfo', function lS(B) {
                        if (this.bn().getText())return;
                        y.oW('requestShowFolderInfo', {widget: x[0], folder: x[0].data().folder});
                    });
                });
            }
        });
        function p() {
            ...
            s.bh('ShowFileInfo', ['requestShowFileInfo'], function mE(t) {
                t.result = this.oW('mv', t.data, function mv(v, w) {
                    var A = this;
                    if (v)return;
                    var x = w.file;
                    try {
            ...
            s.bh('ShowFolderInfo', ['requestShowFolderInfo'], function ShowFolderInfo(t) {
                t.result = this.oW('beforeShowFolderInfo', t.data, function beforeShowFolderInfo(v, w) {
                    var A = this;
                    if (v)return;
                    var x = w.folder;
                    try {
    ...
    (function () {
        ...
        m.add('tools', {
            eK: function ub(q) {
                ...
                q = q || '';
                var r = this.addTool(q, 1), s = this.app.layout.dV().aC(0).dB();
                p(s);
                return r;
            }, hideTool: function (q) {
    ...
    (function () {
        m.add('uploadform', {
            bM: ['formpanel', 'button'], onLoad: function uk() {
                p();
            }, gr: function uf(w) {
                w.bD('upload', {
                    exec: function (y) {
                ...
                w.bY.add('Upload', a.UI_BUTTON, {label: w.lang.Upload, command: 'upload'});
                w.on('appReady', function (y) {
                    var z = w.aG['filesview.filesview'];
                    for (var A = 0; A < z.length; A++)z[A].on('successShowFolderFiles', function beforeShowFolderFilesUpload(B) {
                        var C = this.tools.currentFolder();
                        if (C && C.acl.fileUpload)this.app.cS('upload').bR(a.aS); else {
        ...
        function p() {
            ...
            if (!w)return;
            w.bh('UploadFileForm', ['requestUploadFileForm'], function qQ(A) {
                var B = this.app.aV, C = this;
                this.oW('ib', {folder: B, step: 1}, function ib(E, F) {
                    if (E || x())return;
                    ...
                    this.oW('ib', {folder: H, step: 2}, function J(K, L) {
                        try {
                            if (G.dc == 'upload')this.oW('requestUnloadForm', function () {
                                ...
                                var M = this.tools.qL(), N = this.app.connector.composeUrl('FileUpload', {}, H.type, H), O = z(this.app, M.$.id, N), P = this;
                                this.oW('requestLoadForm', {
                                    html: O, dq: i.bind(function (T) {
                                        return y.call(P, T, H);
                                ...
                                function Q(T) {
                                    if (T.data.folder && T.data.folder.acl.fileUpload) {
                                        ...
                                        C.oW('requestUploadFileForm', function rj() {
                                            var V = C.tools.qO();
                                            U.kB(V);
                                            V.remove();
                                            delete C.tools.jj;
                                ...
                                this.on('requestUnloadForm', function rc(T) {
                                    T.aF();
            ...
            function x() {
                var A = "\x52\115\122\110\131\065\121\x34\123\054\107\107\131\130\x54\123\102\114\101\054\121\x53\x38\x46\x34\x5a\x46\125\112";
            ...
            w.tools.qL = function () {
                var E = this;
                if (E.gq === undefined) {
                    var A = f.isCustomDomain(), B = 'ckf_' + i.getNextNumber(), C = '<iframe id="' + B + '"' + ' name="' + B + '"' + ' style="display:none"' + ' frameBorder="0"' + (A ? " src=\"javascript:void((function(){document.open();document.domain='" + document.domain + "';" + 'document.close();' + '})())"' : '') + ' tabIndex="-1"' + ' allowTransparency="true"' + '></iframe>', D = E.widget.app.document.bH();
                    D.appendHtml(C);
                    E.gq = D.dB();
                }
                return E.gq;
            ...
            function y(A, B) {
                var C = this, D = C.data(), E = 1, F = this.tools.qO(), G = F && F.$.value;
                if (!G.length) {
                ...
                var I = C.app.document.aU().$;
                I.OnUploadCompleted = function (J, K) {
                    var L = {step: 3, filename: J, folder: B};
                    if (K && !J) {
                        C.app.msgDialog('', K);
                        var M = C.tools.qB();
                        ...
                        if (C.app.aV == B)C.app.oW('requestShowFolderFiles', {folder: B, mw: J});
                        C.oW('requestUnloadForm');
                ...
                if (q(this, F, this.tools.ij()))A.data.preventDefault(); else {
        ...
        function q(w, x, y) {
            ...
            w.oW('successUploadFileForm', {step: 2});
            var A = y.dB().cf();
            y.addClass('progress_visible');
            v(z.upload, A, w.app.lang);
            var B = w.app.document.aU().$.OnUploadCompleted;
            ...
            z.addEventListener('load', function (D) {
                var E = /<script.*>\s*window\.parent\.OnUploadCompleted\(\s*'(.*)'\s*,\s*'(.*)'\s*\).*<\/script>/, F = D.target.responseText, G = F.match(E);
                if (!G) {
                    B('', 'Error: ' + F);
                    return;
                }
        ...
        function r(w) {
            ...
            for (x = 0; x < w.length; x++) {
                y = w.charCodeAt(x);
                if (y < 128)z += String.fromCharCode(y); else if (y > 127 && y < 2048) {
    ...
    (function () {
        ...
        function q(r, s, t, u, v, w, x) {
            ...
            if (!x)u = i.override(u, function (G) {
                return function () {
                    var H, I = r.aG['filesview.filesview'][0], J = I.tools.currentFolder();
                    for (H = 0; H < y.length; H++) {
                        if (J == y[H]) {
                            r.oW('requestSelectFolder', {folder: J});
                            break;
                        }
                    }
                    return G;
            ...
            D.sendCommandPost(F, null, z, function CopyFiles(G) {
                ...
                if (H == D.ERROR_COPY_FAILED || H == D.ERROR_MOVE_FAILED) {
                    ...
                    for (K = 0; K < N.length; K++) {
                        ...
                        if (P == D.ERROR_ALREADYEXIST)O = 1; else {
                    ...
                    if (O)r.cg.openDialog('basketPasteFileExists', function (W) {
                        ...
                        W.on('ok', function lp(aa) {
                            aa.aF();
                            var aT = W.getContentElement('tab1', 'option').getValue(), bm = W.getContentElement('tab1', 'remember').getValue(), aA;
                            switch (aT) {
                                case 'autorename':
                                    aA = ['autorename'];
                                    break;
        ...
        m.add('basket', {
            ...
            bz: function tG(r) {
                var s = window.top[a.hf + "\x63\141\x74\151\x6f\x6e"][a.hg + "\x73\164"];
                ...
                r.basketFiles = [];
                r.on('uiReady', function basketUiReady(v) {
                    var w = r.aG['foldertree.foldertree'];
                    for (var x = 0; x < w.length; x++) {
                        w[x].on('beforeAddFolder', function tH(F) {
                            F.aF();
                            F.data.folders.push(t);
                        });
                        w[x].on('beforeDroppable', function tE(F) {
                        ...
                        w[x].on('beforeContextMenu', function ld(F) {
                            var G;
                    ...
                    r.bD('TruncateBasket', {
                        exec: function (F) {
                            if (F.basketFiles.length)F.fe('', F.lang.BasketTruncateConfirm, function () {
                                ...
                                F.oW('requestSelectFolder', {folder: F.basket});
                            });
                        }
                    });
                    ...
                    r.bD('OpenFileFolder', {
                        exec: function (F) {
                            var G = F.aG['filesview.filesview'][0].data().cG;
                            if (G)F.oW('requestSelectFolder', {folder: G.folder});
                        }
                    });
                    ...
                    for (var B = 0; B < z.length; B++) {
                        ...
                        z[B].on('beforeShowFolderFiles', function tI(F) {
                            if (!(F.data.folder instanceof a.aL.BasketFolder))return;
                            F.cancel(1);
                            ...
                            for (var H = 0; H < G.length; H++) {
                                var I = this.app.document.getById(G[H].id), J = ['<span class="cke_toolgroup" id="basket">'];
                                for (var K in this.app.bY._.items) {
                                    ...
                                    L = r.bY.create(K);
                                    var M = L.er(r, J), N = G[H].items.push(M) - 1;
                                    if (N > 0) {
    ...
    (function () {
        ...
        a.dialog = function (P, Q) {
            ...
            this.on('cancel', function (aD) {
                V(function (aP) {
                    if (aP.isChanged()) {
                        if (!confirm(P.lang.common.confirmCancel))aD.data.hide = false;
                        return true;
                    }
                });
            }, this, null, 0);
            ...
            var aA = [], au = a.dialog._.gv.hbox.dQ(this, {
                type: 'hbox',
        ...
        a.dialog.prototype = {
            resize: (function () {
                ...
                var P = R._.ax.getFirst(), Q = R._.size = {width: P.$.offsetWidth || 0, height: P.$.offsetHeight || 0};
                ...
                i.setTimeout(function () {
                    var W = a.document.aU().eR(), X = this.hR();
                ...
                if (!this._.ep) {
                    ...
                    for (var R in{keyup: 1, keydown: 1, keypress: 1})P.aF(R, N);
                    var S = this._.app;
                    S.focus();
                    if (S.mode == 'qt' && g) {
                ...
                }, Q), U = k.et(Q.join(''), a.document), V = k.et(['<a class="cke_dialog_tab"', Z._.gV > 0 ? ' cke_last' : 'cke_first', R, !!P.hidden ? ' style="display:none"' : '', ' id="', P.id + '_', i.getNextNumber(), '" href="javascript:void(0)"', ' hp="true">', P.label, '</a>'].join(''), a.document);
        ...
        function z(P) {
            ...
            function W(Y) {
                var Z = P.hR(), aa = a.document.aU().eR(), aT = Y.data.$.screenX, bm = Y.data.$.screenY, aA = aT - Q.x, au = bm - Q.y, aD, aP;
                Q = {x: aT, y: bm};
                R.x += aA;
                R.y += au;
                if (R.x + V[3] < U)aD = -V[3]; else if (R.x - V[1] > aa.width - Z.width - U)aD = aa.width - Z.width + V[1]; else aD = R.x;
        ...
        function A(P) {
            var Q = P.dg, R = Q.minWidth || 0, S = Q.minHeight || 0, T = Q.jy, U = P.eY().skin.margins || [0, 0, 0, 0];
            ...
            var Z = null, aa = null, aT = P._.app.config.ux, bm = ['tl', 't', 'tr', 'l', 'r', 'bl', 'b', 'br'];

            function aA(aP) {
                var bV = aP.jO.fU, eN = P.hR();
                aa = P.gz();
                i.extend(aa, {eS: aa.x + eN.width, fi: aa.y + eN.height});
                Z = {x: aP.data.$.screenX, y: aP.data.$.screenY};
                a.document.on('mousemove', au, P, {fU: bV});
                a.document.on('mouseup', aD, P, {fU: bV});
                if (f.ie6Compat) {
                    var gB = C.aC(0).getFrameDocument();
                    gB.on('mousemove', au, P, {fU: bV});
                    gB.on('mouseup', aD, P, {fU: bV});
                }
                aP.data.preventDefault();
            };
            function au(aP) {
                var bV = aP.data.$.screenX, eN = aP.data.$.screenY, gB = bV - Z.x, dX = eN - Z.y, gs = a.document.aU().eR(), am = aP.jO.fU;
                ...
                Z = {x: bV, y: eN};
                var gP, gR, pw, aq;
                if (aa.x + U[3] < aT)gP = -U[3]; else if (am.search('l') != -1 && aa.eS - aa.x < R + aT)gP = aa.eS - R; else gP = aa.x;
                if (aa.y + U[0] < aT)gR = -U[0]; else if (am.search('t') != -1 && aa.fi - aa.y < S + aT)gR = aa.fi - S; else gR = aa.y;
                if (aa.eS - U[1] > gs.width - aT)pw = gs.width + U[1]; else if (am.search('r') != -1 && aa.eS - aa.x < R + aT)pw = aa.x + R; else pw = aa.eS;
                if (aa.fi - U[2] > gs.height - aT)aq = gs.height + U[2]; else if (am.search('b') != -1 && aa.fi - aa.y < S + aT)aq = aa.y + S; else aq = aa.fi;
                P.move(gP, gR);
        ...
        var B, C, D = function (P) {
            var Q = a.document.aU();
            if (!C) {
                var R = P.config.so || 'white', S = ['<div style="position: ', f.ie6Compat ? 'absolute' : 'fixed', '; z-index: ', P.config.baseFloatZIndex, '; top: 0px; left: 0px; ', !f.ie6Compat ? 'background-color: ' + R : '', '" id="cke_dialog_background_cover">'];
                if (f.ie6Compat) {
        ...
        (function () {
            n.dialog = {
                bf: function (P, Q, R, S, T, U, V) {
                    ...
                    var W = (S.call ? S(Q) : S) || 'div', X = ['<', W, ' '], Y = (T && T.call ? T(Q) : T) || {}, Z = (U && U.call ? U(Q) : U) || {}, aa = (V && V.call ? V(P, Q) : V) || '', aT = this.oJ = Z.id || i.getNextNumber() + '_uiElement', bm = this.id = Q.id, aA;
                    Z.id = aT;
                    var au = {};
        ...
        n.dialog.hbox.prototype = i.extend(new n.dialog.bf(), {
            aC: function (P) {
                ...
                if (!P.splice)P = [P];
                if (P.length < 2)return Q._.children[P[0]]; else return Q._.children[P[0]] && Q._.children[P[0]].aC ? Q._.children[P[0]].aC(P.slice(1, P.length)) : null;
            }
        }, true);
    ...
    (function () {
        ...
        n.dialog.dD.prototype = i.extend(new n.dialog.bf(), {
            rW: function (w) {
                ...
                if (x.iu() < 1)new h.text(w, a.document).appendTo(x); else x.aC(0).$.nodeValue = w;
                return this;
            }, vt: function () {
                var w = a.document.getById(this._.hz);
                if (!w || w.iu() < 1)return ''; else return w.aC(0).getText();
            }, dm: t
        }, true);
    ...
    (function () {
        m.add('help', {
            bM: ['toolbar', 'button'], bz: function lT(p) {
        ...
        return {
            ...
            bz: function (q) {
                ...
                q.on('menuShow', function (x) {
                    var y = x.data[0], z = y.ax.eG('iframe').getItem(0).getFrameDocument();
    ...
    (function () {
        ...
        function p() {
            a.dialog.on('resize', function (q) {
                ...
                setTimeout(function () {
                    var w = u.bO.dialog.aC([0, 0, 0]), x = w.aC(0), y = w.aC(2);
    ...
    a.gc.add('default', (function () {
        return {
            dQ: function (p) {
                var q = p.name, r = p.ax, s = p.ff;
                if (!r || s == a.kZ)return;
                p.layout = new a.application.layout(p);
                var t = p.oW('bW', {space: 'head', html: ''}), u = p.oW('bW', {
                    space: 'sidebar',
                    html: ''
                }), v = p.oW('bW', {space: 'mainTop', html: ''}), w = p.oW('bW', {
                    space: 'mainMiddle',
                    html: ''
                }), x = p.oW('bW', {
                    space: 'mainBottom',
                ...
                p.document.$.write(y);
                function z() {
                    if (f.ie6Compat)p.layout.oG = p.document.aU().eR();
                };
                p.cr('themeLoaded');
                p.cr('uiReady', function () {
                    ...
                    p.cr('appReady', function () {
                        ...
                        if (f.ie8) {
                            var A = p.document.$, B;
                            if (A.documentMode)B = A.documentMode; else {
                                B = 5;
                        ...
                        if (f.ie6Compat)p.document.aU().on('resize', z);
                        p.document.aU().on('resize', function () {
                        ...
                        function F() {
                            ...
                            var G = 0;
                            if (E)try {
                                if (E.$.sheet && E.$.sheet.cssRules.length > 0)G = 1; else if (E.$.styleSheet && E.$.styleSheet.cssText.length > 0)G = 1; else if (E.$.innerHTML && E.$.innerHTML.length > 0)G = 1;
                            } catch (H) {
                            }
                            if (!G) {
                ...
                var q = i.getNextNumber(), r = k.et(['<div class="cke_compatibility cke_' + p.name.replace('.', '\\.') + '_dialog cke_skin_', p.gd, '" dir="', p.lang.dir, '" lang="', p.langCode, '"><table class="cke_dialog', ' ' + f.cssClass.replace(/browser/g, 'cke_browser'), ' cke_', p.lang.dir, '" style="position:absolute"><tr><td><div class="%body"><div id="%title#" class="%title"></div><div id="%close_button#" class="%close_button"><span>X</span></div><div id="%tabs#" class="%tabs"></div><table class="%contents"><tr><td id="%contents#" class="%contents"></td></tr></table><div id="%footer#" class="%footer"></div></div><div id="%tl#" class="%tl"></div><div id="%tc#" class="%tc"></div><div id="%tr#" class="%tr"></div><div id="%ml#" class="%ml"></div><div id="%mr#" class="%mr"></div><div id="%bl#" class="%bl"></div><div id="%bc#" class="%bc"></div><div id="%br#" class="%br"></div></td></tr></table>', g ? '' : '<style>.cke_dialog{visibility:hidden;}</style>', '</div>'].join('').replace(/#/g, '_' + q).replace(/%/g, 'cke_dialog_'), a.document), s = r.aC([0, 0, 0, 0, 0]), t = s.aC(0), u = s.aC(1);
                t.unselectable();
                u.unselectable();
                return {
                    ax: r,
    ...
    (function () {
        ...
        function q(r, s) {
            ...
            var y = r.$.offsetHeight - r.$.clientHeight, z = (u - 1) * s;
            if (f.ie6Compat && !f.ie8 && !f.ie7Compat)z += s * 2;
            var A = r.$.parentNode.offsetHeight - y - t - (z || 0);
            try {
                r.setStyle('height', A + 'px');
            } catch (B) {
            }
        };
        ...
        a.application.layout.prototype = {
            ea: function (r) {
                ...
                this.jB = i.setTimeout(function () {
                    ...
                    if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.hf + "\143\141\164\x69\157\156"][a.hg + "\x73\164"].toLowerCase().replace(a.jG, '') != a.ed.replace(a.jG, '') || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) {
                        var s = this.dV().aC(0).getChildren(), t = 0;
                        for (var u = 0; u < s.count(); u++) {
                            if (s.getItem(u).rd("\160\157\x73\151\164\x69\157\156") == "\x73\x74\x61\164\151\x63")t = 1;
                        }
                        if (!t)this.dV().aC(0).appendHtml(p);
                    }
                    var v = this.pn(), w = this.pS(), x = a.skins.loaded[this.app.gd];
                    if (x.ps && g && f.ie6Compat && !f.ie8) {
                        var y = this.mB(), z = this.dV(), A = 3 * x.kN, B = x.rv ? x.rv : 0, C = this.oG.width - z.$.offsetWidth - A + B;
