...
if (isset($_POST['submit'])) {
    ...
    if ($obj->update()) {
        ...
        echo "<script>document.location.href=\"contactus.php\";</script>";
        exit;
    } else {
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="page-header"><a href="contactus.php">聯絡我們管理</a>>編輯聯絡我們</h4>
                    </div>
                    <!-- /.col-lg-12 -->
                    <div class="row">
                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-6">
                                            <form role="form" method="post">
                                                <div class="panel panel-success">
                                                    ...
                                                    <div class="panel-body">
                                                        <label>公司名稱：</label><?php echo $result['company']; ?><br/>
                                                        <label>單位：</label><?php echo $result['department']; ?><br/>
                                                        <label>聯絡人：</label><?php echo $result['contact']; ?><br/>
                                                        <label>性別：</label><?php echo $result['sex']; ?><br/>
                                                        <label>電話：</label><?php echo $result['tel']; ?> # <?php echo $result['extension']; ?><br/>
                                                        <label>手機：</label><?php echo $result['mobi']; ?><br/>
                                                        <label>E-MAIL：</label><?php echo $result['email']; ?><br/>
                                                        <label>公司地址：</label><?php echo $result['addr']; ?><br/>
                                                        <fieldset>
                                                            <label>諮詢內容</label>
                                                            <br/>
