...
class ClassAbout extends Database
{
    ...
    function setSQL()
    {
        ...
        $this->add_sql .= " (title, content, flag) ";
        $this->add_sql .= " VALUES ('$this->title','$this->content', ";
        $this->add_sql .= " '$this->flag' ) ";

        $this->delete_sql = "DELETE FROM $tableName  WHERE id='$this->id'";

        $this->update_sql = "UPDATE $tableName  SET title='$this->title', content='$this->content',flag='$this->flag'  ";
