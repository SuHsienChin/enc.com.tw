...
class ClassAdmin extends Database
{
    public $db;
    private $id;
    ...
    function setSQL()
    {
        $tableName = "adminsidebar";
        $this->select_sql = "SELECT * FROM $tableName WHERE parentId='0'";
        ...
        $this->retrieve_sql = "SELECT qandaclass.name as className,qandaclass.id,qanda.id,qanda.classId,qanda.name,qanda.content,qanda.sort,qanda.flag,qanda.creater,qanda.creatDate FROM qandaclass,qanda WHERE qandaclass.id=qanda.classId AND qandaclass.id='$this->id' ";
